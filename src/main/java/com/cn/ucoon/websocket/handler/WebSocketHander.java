...
//		
       ...
       /* if(fromUserID!= null && toUserID != null){
            ...
            Integer count = 5;
        	List<HashMap<String, Object>> list = messageService.selectMsgHistory(Integer.valueOf(fromUserID), Integer.valueOf(toUserID), 0, count);
    ...
    public void handleMessage(WebSocketSession webSocketSession, WebSocketMessage<?> webSocketMessage) throws Exception {
    	...
    	String headurl = userService.getHeadUrl(message.getInteger("from_user_id"));
    	//存数据库
    	...
    	if(messageService.insert(messages)){
        	...
        	array.add(message);
        	sendMessageToUser(message.getString("to_user_id"), new TextMessage(array + ""));
